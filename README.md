...
<table>
  ...
  <tr>
    ...
    <b>등록</b> : 입력된 사진과 게시글 내용을 포함하여 작성시간, 유저정보 등을 Firebase에 저장하고 게시판 목록으로 이동합니다.</td>
  </tr>
  <tr>
    ...
    <b>댓글 목록</b> : 해당 게시글에 유저들이 작성해 둔 댓글 내용을 Firebase에서 불러와서 보여줍니다.
    <b>X</b> : 댓글을 삭제할 수 있습니다. 본인의 댓글만 삭제 가능하며 타인의 댓글을 삭제하려고 할 시 권한이 없다는 토스트 메시지를 표시합니다.<br>
    <b>댓글 등록</b> : 입력된 댓글 내용과 작성시간, 유저정보 등을 Firebase에 저장하고 즉시 댓글 목록에 나타냅니다.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><b>좌석안내[Activity]</b></td>
    <td>좌석안내를 클릭시 이동하는 페이지로 경기가 열리는 롤파크의 좌석을 안내, 좌석 선택 팁과 티켓 가격 정보를 알려줍니다.</td>
  </tr>
  <tr>
    <td><b>경기일정[Activity]</b></td>
    <td>경기일정을 클릭시 이동하는 페이지로 LCK의 모든 경기 일정을 알려줍니다.</td>
  </tr>
  <tr>
    <td><b>개요[Fragment]</b></td>
    <td>LCK에 대한 정보를 안내하는 프래그먼트 입니다.<br />상단 <b>동영상</b>은 유튜브 플레이어를 사용하여 LCK 공식 영상을 재생시켰습니다.</td>
  </tr>
  <tr>
    <td><b>진행방식[Fragment]</b></td>
    <td>LCK 경기 진행방식에 대해 안내하는 프래그먼트 입니다.</td>
  </tr>
  <tr>
    <td><b>대회상금[Fragment]</b></td>
    <td>LCK 상금에 대해 안내하는 프래그먼트 입니다.</td>
  </tr>
</table>
...
<table>
  <tr>
    <td><b>샵[ShopActivity]</b></td>
    <td>LoL과 관련된 상품(굿즈)를 판매하는 페이지입니다.<br /><b>슬라이더</b>는 관리자페이지의 샵이벤트와 연결되는 것으로 샵이벤트에서 등록된 배너 이미지로 롤링됩니다.<br />슬라이더 이미지나 리사이클러뷰의 상품 이미지를 클릭시 해당 상품의 디테일 페이지로 이동합니다.</td>
  </tr>
  <tr>
    <td><b>상품디테일[ShopDetailActivity]</b></td>
    <td>ShopActivity에서 상품 이미지를 선택 후 이동되는 페이지로 상품의 구체적인 이미지를 볼 수 있습니다.<br />구매를 원할 경우 <b>수량</b>을 선택 후 <b>구매하기</b> 버튼을 클릭하면 구매페이지로 이동합니다.<br />수량에 따라 가격이 변동되어 보여지며 수량이 0일 경우와 1보다 아래로 수량을 선택하려는 경우을 토스트 메세지로 잘못됐음을 표시합니다.</td>
  </tr>
  <tr>
    <td><b>상품구매[PurchaseActivity]</b></td>
    <td>구매를 요청하는 페이지로 주문 상품과 수량, 가격을 확인할 수 있습니다.<br />배송정보의 <b>변경</b> 버튼을 클릭시 배송지 주소를 변경할 수 있습니다.<br /><b>배송메세지</b>는 스피너로 작성되었으며 원하는 메세지를 선택이 가능합니다.<br /><b>가상머니</b>를 클릭하면 현재 소지한 캐쉬 확인이 가능합니다.<br />약관에 동의하지 않았을 경우 <b>결제하기</b> 버튼 클릭시 약관에 동의해달라는 토스트 메세지가 나타납니다.<br />소지한 캐쉬가 상품 가격보다 적은 경우 캐쉬 충전을 안내하는 다이알로그를 띄웁니다. 충전 확인시 캐쉬충전 페이지로 이동합니다.</td>
  </tr>
  <tr>
    <td><b>구매결과[PurchaseResultActivity]</b></td>
    <td>상품구매 페이지에서 결제가 성공했을 경우 이동하는 페이지로 구매한 상품을 확인할 수 있습니다.<br /><b>확인</b> 버튼을 클릭하면 메인 페이지로 이동합니다.<br /><b>구매내역</b> 버튼을 클릭시 구매내역 페이지로 이동합니다.</td>
  </tr>
  <tr>
    <td><b>구매내역[PurchaseHistoryActivity]</b></td>
    <td>구매한 내역을 보여주는 페이지로 구매한 년도와 날짜, 상품 이미지, 이름, 수량, 배송지 주소, 가격을 보여줍니다.<br />리사이클러뷰를 사용하여 상품을 구매할 때마다 구매 내역이 업데이트 됩니다.</td>
  </tr>
</table>
