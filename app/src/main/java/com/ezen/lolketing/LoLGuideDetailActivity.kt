        ...
        when(status){
            ...
            "position"->{
                ...
                txt_content.text = Html.fromHtml("가장 일반적으로 사용하는 맵(전장)이자 프로 대회 공식 맵인 <b><big>‘소환사의 협곡’</b></big>에는 총 세 개의 라인이 존재합니다. 경기 초반 각 챔피언은 하나의 라인을 담당해 포탑을 지키는 임무를 수행합니다. 그리고 해당 라인을 담당하는 적팀 챔피언과 지속해서 전투를 벌이며 적을 제압할 기회를 노리기도 합니다. <b><big>잠깐,</b></big> 롤은 5:5 경기라고 했는데 라인이 세 개밖에 없는 것이 이상하다고요? 아래 설명을 보시면 이해가 될 겁니다.<br>" +
                        ...
                        "<br>" +
                        "<b><big>2. <font color=\"#E8AB60\">미드 라인</font></big></b> : 소환사의 협곡 <b><big>중심</big></b>을 향해 뻗어 있는 길을 의미합니다. 이곳을 담당하는 챔피언을 <b><big>‘미드 라이너’</big></b>라고 부릅니다. 순간적으로 적을 제압하는 전투가 자주 발생하는 지역입니다. 팬들 사이에서 ‘세체미(세계 최고 미드 라이너를 뜻하는 약어)’로 불리는 SK텔레콤 T1의 페이커 선수가 담당하고 있는 라인이 바로 이 미드 라인입니다. 미드 라인은 주로 공격력이 강하고 방어력이 약한 챔피언들이 담당하기 때문에 순간적인 판단과 기지에 따라 적을 제압하느냐, 적에게 제압당하느냐가 갈리는 곳입니다.<br>" +
                        "<br>" +
                        "<b><big>3. <font color=\"#909DF7\">바텀(약칭 봇) 라인</font></big></b> : 세 라인 중 유일하게 <b><big>두 명의 챔피언이 담당</big></b>하는 지역입니다. 이곳을 담당하는 챔피언은 <b><big>‘원딜러(약칭 원딜)’와 ‘서포터(약칭 서폿)’</big></b>로 불립니다. 적팀의 챔피언까지 모두 4명의 챔피언이 존재하기 때문에 치열한 전투가 꾸준하게 발생하는 곳이지요. 미드 라이너나 탑 라이너까지 이곳에 합류해 자주 전투를 벌이기도 합니다.<br>" +
                        "<br>" +
                        "<b><big>4. <font color=\"#5EAB81\">정글</font></big></b> : 탑, 미드, 바텀 라인을 제외한 맵의 중앙 부분을 통틀어 <b><big>‘정글’</big></b>이라고 칭합니다. 네 명의 챔피언들이 각 라인을 담당하면 남은 한 명의 챔피언이 바로 이 정글 지역 전체를 담당합니다. 그리고 정글 지역을 담당하는 챔피언은 <b><big>‘정글러’</big></b>로 불립니다. 정글 지역에는 처치 시 골드와 경험치를 제공하는 중립 몬스터들이 존재하며, 정글러들은 이 몬스터들을 처치하며 성장합니다.<br>" +
                        "<br>" +
