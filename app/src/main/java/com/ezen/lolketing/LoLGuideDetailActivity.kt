        ...
        when(status){
            ...
            "score"->{
                ...
                txt_content.text = Html.fromHtml("롤에 관한 대화나 대회 중계방송을 듣다 보면 자주 언급되는 용어가 있습니다. 그 중 가장 대표적인 것들을 꼽자면 ‘킬/어시’, ‘KDA’, ‘CS’인데요. 이 용어들은 어떤 팀이 어떤 득점을 얼마나 했는지를 가늠할 수 있게 해주는 일종의 점수를 의미합니다. 이 용어들만 알아도 현재 어느 팀이 유리한지 한눈에 파악할 수 있습니다.<br>" +
                        ...
                        "<br>" +
                        "<b><big>2. KDA</big></b> : KDA란, <b><big>킬 수와 어시스트 수의 합을 데스의 수로 나눈</big></b> 수치를 의미합니다. 게임 시스템상으로는 노출되지 않는 수치이지만, 각 챔피언의 활약도를 파악하는 용도로 유저들이 생성해 낸 개념입니다. 공식적인 기준은 없지만, 일반적으로 챔피언의 KDA 수치가 3 이상이면 해당 챔피언은 게임 내에서 충분한 활약을 하고 있다고 여깁니다.<br>" +
                        "<br>" +
                        "<b><big>3. CS</big></b> : ‘롤의 꽃’이라고 말해도 무방할 정도로 중요한 수치입니다. 적팀 넥서스에서 생성되는 <b><big>미니언들을 처치한 횟수</big></b>를 뜻하는 수치입니다. CS 수치가 높을수록 적 미니언을 많이 처치한 것이고, 그만큼 많은 골드를 벌어들였다는 뜻입니다. 전술했듯이, 높은 골드는 좋은 아이템을 의미하며 이는 곧 다음 전투에서의 상대적 우위를 내포하고 있으므로 높은 CS 수치를 기록하고 있는 챔피언은 아주 강력할 확률이 높습니다.<br>" +
                        "<br>" +
