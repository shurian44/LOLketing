...
class ChattingAdapter: ListAdapter<ChattingItem, RecyclerView.ViewHolder>(diffUtil) {
    ...
    override fun getItemViewType(position: Int): Int {
        return if (currentList[position].isLeftTeam) 0 else 1
    }
    ...
    companion object {
        val diffUtil = object : DiffUtil.ItemCallback<ChattingItem>() {
            override fun areItemsTheSame(oldItem: ChattingItem, newItem: ChattingItem) =
                oldItem.nickname == newItem.nickname && oldItem.message == newItem.message
